...
var Client = exports.Client = function(args){
  ...
  this.userAgent = 'drill-client-node ' + exports.version;
...
Client.prototype.query = function(query_id, callback) {
  this.request({ method: 'POST', path: '/query.json' }, function(error, code, body){
    if (error || code !== 200) {
      var message = "query info api returns error" + (body && body.length > 0 ? ":" + body : "");
...
*/
  var req = { method: 'POST', path: '/query.json', headers: headers, body: query };
